...
<html>
	...
	<br><br><br><br>
		...
		<div align="center">
			<form target="_blank" method="get" action="https://image.baidu.com/s">
				<input type="text" placeholder="请输入关键词" name="word" class="text" />
				<input type="submit" value="搜索" class="search">
			</form>
    	</div>
...
!https://www.google.com/search?as_q=一&as_epq=二&as_oq=三&as_eq=四&as_nlo=&as_nhi=&lr=&cr=&as_qdr=all&as_sitesearch=&as_occt=any&safe=images&as_filetype=&tbs=
